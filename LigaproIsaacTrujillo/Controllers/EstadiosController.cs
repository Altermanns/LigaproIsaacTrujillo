...
namespace LigaproIsaacTrujillo.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(LigaproEquipoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Direcion,Ciudad,Capacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Direcion,Ciudad,Capacidad")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
