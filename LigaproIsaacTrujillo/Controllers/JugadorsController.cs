...
namespace LigaproIsaacTrujillo.Controllers
{
    public class JugadorsController : Controller
    {
        private readonly LigaproIsaacTrujilloContext _context;

        public JugadorsController(LigaproIsaacTrujilloContext context)
        {
            _context = context;
        }
        ...
        {
            var ligaproIsaacTrujilloContext = _context.Jugador.Include(j => j.Equipo);
            return View(await ligaproIsaacTrujilloContext.ToListAsync());
        }
        ...
        {
            ViewData["EquipoId"] = new SelectList(_context.Equipo, "Id", "Ciudad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Posicion,Edad,EquipoId")] Jugador jugador)
        {
            ...
            ViewData["EquipoId"] = new SelectList(_context.Equipo, "Id", "Ciudad", jugador.EquipoId);
            return View(jugador);
        }
