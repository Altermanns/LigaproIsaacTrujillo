...
namespace LigaproIsaacTrujillo.Controllers
{
    public class JugadorsController : Controller
    {
        ...
        public JugadorsController(LigaproEquipoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Posición,Edad")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Posición,Edad")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
